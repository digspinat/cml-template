  ...
  return (
      <div style={{ backgroundColor: "#285DAB", padding: "80px"}}>
        <div>
          ...
          <p style={{ fontSize: `100px`, fontWeight: `bold`, marginTop: `-30px`, color: "white" }}>{manual.frontmatter.series}</p>
          ...
          <img src={manual.frontmatter.carimage} height="450px" width="582px"/>
